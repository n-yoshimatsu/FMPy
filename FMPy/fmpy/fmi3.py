...
class _FMU3(_FMU):
    ...
    def __init__(self, **kwargs):
        ...
        self._fmi3Function('fmi3EnterClockActivationMode', [(fmi3Instance, 'instance')])
...
class FMU3ScheduledExecution(_FMU3):
    ...
    def enterClockActivationMode(self):
        return self.fmi3EnterClockActivationMode(self.component)
